<template>
  <div class="content">
    ...
    <div v-if="!showHis" class="list1">
      <div v-for="(item, index) in pageData" :key="index" class="item" @click="gopage(index, 0)">
...
<script lang="ts">
import { getDepts } from '@/api/hospital'
